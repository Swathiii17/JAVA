...
class StudentRecordManagementNew {
    static Scanner sc = new Scanner(System.in);
    static File file = new File("studentsNew.txt");
    ...
    public static void overwriteRecord() throws IOException {
    ...
    bw.close();
    System.out.println("Record written (previous data deleted) successfully!");
}
    ...
    public static void main(String[] args) throws IOException {
        while (true) {
            ...
            System.out.println("5. Over Write Record");
